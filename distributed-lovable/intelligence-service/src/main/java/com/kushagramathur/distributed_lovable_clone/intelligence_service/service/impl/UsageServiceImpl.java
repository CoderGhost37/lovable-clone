...
import com.kushagramathur.distributed_lovable_clone.intelligence_service.client.AccountClient;
import com.kushagramathur.distributed_lovable_clone.intelligence_service.entity.UsageLog;
import com.kushagramathur.distributed_lovable_clone.intelligence_service.repository.UsageLogRepository;
...
public class UsageServiceImpl implements UsageService {
    ...
    public void checkDailyTokensUsage() {
        Long userId = authUtil.getCurrentUserId();
        PlanDto plan = accountClient.getCurrentSubscribedPlan();
