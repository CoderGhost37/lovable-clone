package com.kushagramathur.distributed_lovable_clone.api_gateway.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.kushagramathur.distributed_lovable_clone.api_gateway.config.SecurityProperties;
import com.kushagramathur.distributed_lovable_clone.api_gateway.error.ApiError;
import com.kushagramathur.distributed_lovable_clone.api_gateway.service.JwtGatewayService;
...
public class GatewayJwtAuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        boolean isPublicRoute = securityProperties.getPublicRoutes().stream()
        ...
        try {
            ...
            log.warn("Invalid token for access to: {}", path);
    ...
    private Mono<Void> sendErrorResponse(ServerWebExchange exchange, HttpStatus status, String message) {
        ...
        try {
            ...
            log.error("Error serializing API error response: {}", e.getMessage());
